...
class Perfil(models.Model):
	...
	nombre = models.CharField(validators=[MinLengthValidator(2),MinLengthValidator(50)], max_length=50, blank=False, null=True)
	apellido1 = models.CharField(validators=[MinLengthValidator(2),MinLengthValidator(50)], max_length=50, blank=False, null=True)
	apellido2 = models.CharField(validators=[MinLengthValidator(2),MinLengthValidator(50)], max_length=50, blank=False, null=True)
